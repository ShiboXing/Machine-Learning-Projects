...
$$
  f_n = \alpha_0 + x_n \cdot \beta \cdot \alpha 
$$
...
$$
  f_n = \alpha_0 + \sum^5_{k = 1}(h_{n,k} \cdot \alpha_k)
$$
...
= \frac{\partial (y_n \cdot log(\mu_n))}{\partial \alpha_1} \cdot \frac{\partial (logit^{-1}(f_n))}{\partial \alpha_1} \cdot \frac{\partial f_n}{\partial \alpha_1} - \frac{\partial ((1-y_n) \cdot log(1-\mu_n))}{\partial \alpha_1} \cdot \frac{\partial (logit^{-1}(f_n))}{\partial \alpha_1} \cdot \frac{\partial f_n}{\partial \alpha_1} 
\end{aligned}
$$
...
$$
\begin{aligned}
  \frac{\partial L_n}{\partial \alpha_1} = \frac{\partial (y_n \cdot log(\mu_n))}{\partial \alpha_1} \cdot \frac{\partial (logit^{-1}(f_n))}{\partial \alpha_1} - \frac{\partial ((1-y_n) \cdot log(1-\mu_n))}{\partial \alpha_1} \cdot \frac{\partial (logit^{-1}(f_n))}{\partial \alpha_1} \\ 
= \frac{1}{\mu_n} \cdot \frac{1-f_n}{f_n} \cdot h_{n,k} - \frac{1}{1-\mu_n} \cdot \frac{1-f_n}{f_n} \cdot h_{n,k} 
\end{aligned}
$$
...
solution: We shouldn't be worried. Bagging method simply lets us use the avergae of the predictions from all the trees as the answer, but the number of times each model is trained doesn't increase as the number of trees increases.
