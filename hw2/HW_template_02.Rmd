...
= log(\mu^{189}(1 - \mu)^{413})  \\ 
= 189\cdot log(\mu) + 413\cdot log(1 - \mu)
$$
...
log_binom_pmf(events = 189, trials = 602, prob = 0.3)
### your code here
```
...
dbinom(x = player_hits, size = player_atbats, prob = 0.3, log = TRUE)
```
...
### set input arguments !!!
log_post_sigma_unnorm <- function()
{
  # your code here
}
```
