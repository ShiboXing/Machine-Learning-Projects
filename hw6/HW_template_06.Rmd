...
$$
\begin{aligned}
\delta_n^2 = (y_n - \alpha_0 -\sum_{k=1}^{K}(h_{n,k}\cdot\alpha_k)) ^ 2 \\
...
\frac{\partial}{\partial g_\alpha} \left(SSE\right) = -2 \delta^T \cdot \begin{bmatrix}
1 & H  
\end{bmatrix} \ (append \ a\ column\ of\ 1s)\\ 
\end{aligned}
