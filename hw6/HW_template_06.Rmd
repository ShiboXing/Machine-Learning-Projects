...
\frac{d\delta_n}{d\alpha_k} =2 \cdot (\alpha_0 + h_{n,k}\cdot\alpha_k - y) \cdot h_{n,k} = 2 \cdot \delta_{n,k} \cdot h_{n,k}
\end{aligned}
$$
...
Your solution here, add as many equation blocks as you feel are necessary.  
