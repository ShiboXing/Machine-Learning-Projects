...
pnorm(0.95, laplace_03_line$mode, sigma) - pnorm(0.05, laplace_03_line$mode, sigma)

sigma = laplace_03_cube$var_matrix %>% diag %>% sqrt
pnorm(0.95, laplace_03_cube$mode, sigma) - pnorm(0.05, laplace_03_cube$mode, sigma)
# laplace_03_line$mode %>% quantile(seq(0.05, 0.95, 0.9))
# laplace_03_cube$mode %>% quantile(seq(0.05, 0.95, 0.9))
```
The cubic model beta's 90% uncertainty interval herein contains 0.
