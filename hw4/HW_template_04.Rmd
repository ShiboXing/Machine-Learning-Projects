...
post_lm_pred_samples <- function(Xnew, Bmat, sigma_vector)
{
  ...
  Rmat <- matrix(rep(sigma_vector, M), , byrow = TRUE)
  
  # generate standard normal and assemble into matrix
  Zmat <- matrix(rnorm(M*S), , byrow = TRUE)
