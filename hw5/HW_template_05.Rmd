...
```{r, solution_04c_a}
laplace_result_a <- my_laplace( )

post_samples_a <- generate_lm_post_samples( )
```
...
laplace_result_weak <- my_laplace( )

post_samples_weak <- generate_lm_post_samples( )
```
...
laplace_result_strong <- my_laplace( )

post_samples_strong <- generate_lm_post_samples( )
```
