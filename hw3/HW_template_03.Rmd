...
The change-of-variable of sigma to phi is via the inverse of logit function: 
$$
logit(\frac{\sigma - l}{u - l}) = g(\sigma) = \varphi
$$
$$
\sigma = logit^{-1}(\phi) \cdot (u - l) + l = g^{-1}(\phi)
$$
Thus, through the inverse of the g, we can enforce the upper and lower bound of sigma.
...
### bounds on varphi
varphi_lwr <- qexp(0.01, info_inform_N05$sigma_rate)
varphi_upr <- qexp(0.99, info_inform_N05$sigma_rate)
